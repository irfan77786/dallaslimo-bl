...
$outPath = __DIR__ . '/resources/views/airports';
...
$urlReplacements = [
    ...
    'href="/airports/addison-airport-car-service/"' => 'href="/airports/addison-airport-car-service/"',
    'href="/airports/signature-flight-support-car-service/"' => 'href="/airports/signature-flight-support-car-service/"',
...
function processAirport($htmlFile, $outPath, $bladeName, $urlReplacements)
{
    ...
    $h1 = trim($h1Match[1] ?? 'Airport Car Service');
...
// dallaslimo-bl airports → Laravel blade view names
$airports = [
    'addison-airport-car-service' => 'addison-airport-car-service',
    'dfw-car-service' => 'car-service-dallas-fort-worth-international-airport',
    'love-field-airport-car-service' => 'dallas-love-field-black-car-service',
    'signature-flight-support-car-service' => 'signature-flight-support',
    'waco-regional-airport-car-service' => 'waco-regional-airport',
];

foreach ($airports as $htmlDir => $bladeName) {
    processAirport($baseDir . '/airports/' . $htmlDir . '/index.html', $outPath, $bladeName, $urlReplacements);
}
