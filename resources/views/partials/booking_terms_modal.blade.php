{{-- Booking flow Terms & Conditions modal (payment + booking detail) --}}
<div class="modal fade booking-terms-modal" id="staticBackdrop" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
<p>Welcome to Dallas Limos and Black Car Service! These Terms and Conditions govern your use of this website and our services. By getting access to and the usage of this website and our services, you agree to be bound using those Terms. If you do not agree to those Terms, you can no longer use our offerings or this website. You acknowledge that Dallas Limos and Black Car Service has the right to exchange those Terms at any time without notice to you. Continue to check them from time to time for updates.</p>
                ...
                <p>Dallas Limos and Black Car Service may change the Terms and Conditions at any time. If you continue to use the services, you accept the new Terms and Conditions.</p>
                <h6>3. Services Offered</h6>
                <p>Dallas Limos and Black Car Service is an elite provider of professional chauffeured limousine services, specializing in the following areas:</p>
                <ul>
                ...
                <ul>
                    ...
                    <li><b>Declined Payments:</b> Payments that are declined will require you to provide another form of payment. If the alternate form of payment is not given, it is possible your booking may be canceled. Dallas Limos and Black Car Service is not liable for cancellations on your booking due to payment issues.</li>
                </ul>
                ...
                <ul>
                    <li>The user must first contact Dallas Limos and Black Car Service directly for resolution.</li>
                    ...
                    <li>Users waive their right to bring a class action lawsuit relating to the services of Dallas Limos and Black Car Service or its terms.</li>
                </ul>
            </div>
