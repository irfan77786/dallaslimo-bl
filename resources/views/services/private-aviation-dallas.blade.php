                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-6 h-100">
                        <div class="img-holder ms-md-auto">
                            <img src="{{ asset('assets/private-aviation.JPG') }}" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-lg-4 col-xl-3 d-flex">
                        <article class="we-serve-item custom-card mb-30 mb-md-35">
                            <div class="img-holder">
                                <img src="{{ asset('assets/image-05.jpg') }}" alt="" class="img-fluid">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4 col-xl-3 d-flex">
                        <article class="we-serve-item custom-card mb-30 mb-md-35">
                            <div class="img-holder">
                                <img src="{{ asset('assets/image-06.jpg') }}" alt="" class="img-fluid">
                            </div>
                            <div class="text-detail">
                    ...
                    <div class="col-12 col-sm-6 col-lg-4 col-xl-3 d-flex">
                        <article class="we-serve-item custom-card mb-30 mb-md-35">
                            <div class="img-holder">
                                <img src="{{ asset('assets/image-07.jpg') }}" alt="" class="img-fluid">
                            </div>
                            <div class="text-detail">
                    ...
                    <div class="col-12 col-sm-6 col-lg-4 col-xl-3 d-flex">
                        <article class="we-serve-item custom-card mb-30 mb-md-35">
                            <div class="img-holder">
                                <img src="{{ asset('assets/image-08.jpg') }}" alt="" class="img-fluid">
                            </div>
                            <div class="text-detail">
