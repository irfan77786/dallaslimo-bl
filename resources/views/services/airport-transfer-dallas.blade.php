...
@section('content')
    ...
    <section class="home-banner-section">
        <div class="hero-banner-container py-60 ah-container position-relative py-sm-70 py-md-80 py-lg-100"
             style="z-index: 2; background-image: url('{{ asset('assets/banner-1.webp') }}'); background-size: cover; background-position: center;">
                ...
                <div class="py-20 row">
                    ...
                    <div class="col-12 col-md-4 h-100">
                        <div class="img-holder ms-md-auto">
                            <img loading="lazy" decoding="async" src="{{ asset('assets/why-choose-dallas-black-limo-service.webp') }}" width="406" height="233" class="img-fluid" alt="Uniformed chauffeur for executive travel Dallas">
                        </div>
                    </div>
                </div>
             </div>
                    ...
                    <div class="row">
                        <div class="text-center col-12">
                            <div class="fifa-image-holder">
                                <img loading="lazy" decoding="async" src="{{ asset('assets/fifa-image.png') }}" class="img-fluid" alt="FIFA Image" width="380" height="100%">
                            </div>
...
<img  loading="lazy"
                                decoding="async" src="{{ asset('assets/icon-03.svg') }}" alt="Booking" class="img-fluid">
                            </span>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 mb-25 mb-md-30">
                        <article class="text-center">
                            <span class="mb-10 icon-holder d-block">
<img  loading="lazy"
                                decoding="async" src="{{ asset('assets/icon-02.svg') }}" alt="Confirmation" class="img-fluid">
                            </span>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 mb-25 mb-md-30">
                        <article class="text-center">
                            <span class="mb-10 icon-holder d-block">
<img  loading="lazy"
                                decoding="async" src="{{ asset('assets/icon-01.svg') }}" alt="Driver" class="img-fluid">
                            </span>
        ...
        <section class="py-20 detail-content-section">
            <div class="container">
                <div class="py-20 row">
                    ...
                    <div class="col-12 col-md-4 h-100">
                        <div class="img-holder ms-md-auto">
                            <img loading="lazy" decoding="async" src="{{ asset('assets/dfw-and-love-field-airport-transportation.webp') }}" width="407" height="210" class="img-fluid" alt="Luxury black car at Dallas Love Field Airport">
                        </div>
                    </div>
                </div>
...
Corporate pickups often continue to Las Colinas, Plano, and North Dallas. Every ride is flight-monitored, terminal-matched, and dispatch-managed for smooth curbside pickup and on-time arrival.
                    ...
                    <div class="col-12 col-md-4 h-100">
                        <div class="img-holder">
                            <img loading="lazy" decoding="async" src="{{ asset('assets/executive-black-car-service-for-business-meetings.webp') }}" width="407" height="210" class="img-fluid" alt="Professional chauffeur for black car service Dallas">
                        </div>
                    </div>
                </div>
                <div class="py-20 row d-none d-md-flex">
                    ...
                    <div class="col-12 col-md-4 h-100">
                        <div class="img-holder">
                            <img loading="lazy" decoding="async" src="{{ asset('assets/luxury-black-car-airport-transfer-will-rogers-world-airport.webp') }}" width="407" height="210" class="img-fluid" alt="Professional chauffeur for black car service Dallas">
                        </div>
                    </div>
                </div>
            </div>
...
<img  loading="lazy"
                                decoding="async" src="{{ asset('assets/image-05.jpg') }}" alt="Premium black car service for airport, hotel, and event travel" class="img-fluid">
                            </a>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                        <article class="text-center we-serve-item mb-30 mb-md-35">
                            <a href="" class="mx-auto img-holder mb-15 d-block">
<img  loading="lazy"
                                decoding="async" src="{{ asset('assets/image-06.jpg') }}" alt="Chauffeur service providing safe and comfortable city transportation" class="img-fluid">
                            </a>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                        <article class="text-center we-serve-item mb-30 mb-md-35">
                            <a href="" class="mx-auto img-holder mb-15 d-block">
<img  loading="lazy"
                                decoding="async" src="{{ asset('assets/image-07.jpg') }}" alt="Executive black car service for meetings, conferences, and events" class="img-fluid">
                            </a>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                        <article class="text-center we-serve-item mb-30 mb-md-35">
                            <a href="" class="mx-auto img-holder mb-15 d-block">
<img  loading="lazy"
                                decoding="async" src="{{ asset('assets/image-08.jpg') }}" alt="Airport pickup service with professional chauffeur and luxury vehicle" class="img-fluid">
                            </a>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 mb-25 mb-md-30">
                        <article class="text-center">
                            <span class="mb-10 icon-holder d-block">
                                <img loading="lazy" decoding="async" src="{{ asset('assets/car-steering.svg') }}" alt="Confirmation" class="img-fluid" width="40" height="40">
                            </span>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 mb-25 mb-md-30">
                        <article class="text-center">
                            <span class="mb-10 icon-holder d-block">
                                <img loading="lazy" decoding="async" src="{{ asset('assets/dimond.svg') }}" alt="Driver" class="img-fluid" width="40" height="40">
                            </span>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-lg-4">
                        <article class="mb-20 top-cities-item mb-sm-25 mb-md-30">
                            ...
                            <div class="img-holder">
                                <img loading="lazy" width="416" height="199" decoding="async" src="{{ asset('assets/austin.webp') }}" alt="Top City" class="img-fluid">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        <article class="mb-20 top-cities-item mb-sm-25 mb-md-30">
                            ...
                            <div class="img-holder">
                                <img loading="lazy" width="416" height="199" decoding="async" src="{{ asset('assets/houston.webp') }}" alt="Top City" class="img-fluid">
                            </div>
                            <div class="city-details p-15 position-absolute">
                                <h3 class="mb-0 text-white h6">Dallas
                                    <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium mui-style-nw1xan" focusable="false" aria-hidden="true" width="24" viewBox="0 0 24 24" data-testid="ChevronRightIcon">
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        <article class="mb-20 top-cities-item mb-sm-25 mb-md-30">
                            ...
                            <div class="img-holder">
                                <img loading="lazy" width="416" height="199" decoding="async" src="{{ asset('assets/college-station.webp') }}" alt="Top City" class="img-fluid">
                            </div>
                            <div class="city-details p-15 position-absolute">
                                <h3 class="mb-0 text-white h6">Dallas
                                    <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium mui-style-nw1xan" focusable="false" aria-hidden="true" width="24" viewBox="0 0 24 24" data-testid="ChevronRightIcon">
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        <article class="mb-20 top-cities-item mb-sm-25 mb-md-30">
                            ...
                            <div class="img-holder">
                                <img loading="lazy" width="416" height="199" decoding="async" src="{{ asset('assets/oklahoma-city.webp') }}" alt="Top City" class="img-fluid">
                            </div>
                            <div class="city-details p-15 position-absolute">
                                <h3 class="mb-0 text-white h6">Dallas
                                    <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium mui-style-nw1xan" focusable="false" aria-hidden="true" width="24" viewBox="0 0 24 24" data-testid="ChevronRightIcon">
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        <article class="mb-20 top-cities-item mb-sm-25 mb-md-30">
                            ...
                            <div class="img-holder">
                                <img loading="lazy" width="416" height="199" decoding="async" src="{{ asset('assets/tyler.webp') }}" alt="Top City" class="img-fluid">
                            </div>
                            <div class="city-details p-15 position-absolute">
                                <h3 class="mb-0 text-white h6">Dallas
                                    <svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium mui-style-nw1xan" focusable="false" aria-hidden="true" width="24" viewBox="0 0 24 24" data-testid="ChevronRightIcon">
                    ...
                    <div class="col-12 col-sm-6 col-lg-4">
                        <article class="mb-20 top-cities-item mb-sm-25 mb-md-30">
                            ...
                            <div class="img-holder">
                                <img loading="lazy" width="416" height="199" decoding="async" src="{{ asset('assets/waco.webp') }}" alt="Top City" class="img-fluid">
                            </div>
                            <div class="city-details p-15 position-absolute">
            ...
            <div class="container">
                <div class="row">
                    <div class="text-center col-12">
                        <div class="fifa-image-holder">
                            <img  loading="lazy"
decoding="async" src="{{ asset('assets/fifa-image.png') }}" class="img-fluid" alt="FIFA Image">
                        </div>
