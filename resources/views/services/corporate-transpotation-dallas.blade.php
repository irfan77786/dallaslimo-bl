            ...
            <div class="col-12 col-md-4 h-100">
                <div class="img-holder ms-md-auto">
                    <img loading="lazy" decoding="async"
                        src="{{asset('assets/why-choose-dallas-black-limo-service.webp')}}" width="406"
    ...
    <div class="container">
        <div class="py-20 row">
            ...
            <div class="col-12 col-md-4 h-100">
                <div class="img-holder ms-md-auto">
                    <img loading="lazy" decoding="async"
                        src="{{asset('assets/dfw-and-love-field-airport -transportation.webp')}}" width="407" height="210"
        ...
        <div class="flex-row-reverse py-20 row">
            ...
            <div class="col-12 col-md-4 h-100">
                <div class="img-holder">
                    <img loading="lazy" decoding="async"
                        src="{{ asset('assets/executive-black-car-service-for-business-meetings.webp') }}" width="407"
                ...
                <div class="companies-logo-marquee">
                    <div class="companies-logo-track">
                        ...
                        <div class="py-10 px-15">
                            <span class="img-holder">
                                <img loading="lazy" width="90" height="60" decoding="async"
                                    src="{{ asset('assets/logo-0' . $i . '.webp') }}" alt="Logo"
                                    class="img-fluid">
                            </span>
                        </div>
                        @endforeach
                        ...
                        <div class="py-10 px-15">
                            <span class="img-holder">
                                <img loading="lazy" width="90" height="60" decoding="async"
                                    src="{{ asset('assets/logo-0' . $i . '.webp') }}" alt=""
                                    class="img-fluid">
                            </span>
                        </div>
                        @endforeach
