...
<head>
    ...
    <meta property="og:image" content="{{ $seo['og_image'] ?? $brandLogoAsset }}">
    ...
    <meta name="twitter:description"
        content="{{ $seo['og_description'] ?? $seo['description'] ?? 'Premium black car and limousine service in Dallas, Texas.' }}">
    <meta name="twitter:image" content="{{ $seo['og_image'] ?? $brandLogoAsset }}">
    ...
    <link rel="preload" href="{{ $brandLogoAsset }}" as="image">
        ...
        <div class="ah-container position-relative">
            <div class="row align-items-center">
                <div class="col-6 col-lg-3">
                    <div class="logo">
                        <a href="/">
                            @include('partials.brand-logo', ['alt' => $brandLogoAlt])
                        </a>
                    </div>
                </div>
                @if($hideHeaderItems)
                ...
                <div class="col-6 col-lg-9 d-flex align-items-center justify-content-end">
                    <nav class="p-0 custom-navbar navbar navbar-expand-lg position-static">
                        ...
                        <div class="collapse navbar-collapse ms-auto" id="navbarSupportedContent">
                            <ul class="mb-2 navbar-nav ms-auto mb-lg-0">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link @if(request()->path() == 'book-now') active @endif"
                                        href="/book-now/">Book Now
                                    </a>
                                </li>
                    ...
                    <a href="/get-a-quote" class="btn btn-primary d-none d-xl-block" style="min-width: 100px;">Get a
                        quote</a>
                </div>
                @endif
            </div>
                    ...
                    <div class="col-12">
                        ...
                        <ul class="footer-nav-list-item list-unstyled mb-30 mb-lg-0">
                            ...
                            <li class="gap-2 d-flex align-items-center">
                                ...
                                <a href="tel:+12134526789">+1 214-919-5377</a>
                            </li>
                            <li class="gap-2 d-flex align-items-center">
                                <svg width="19" height="19" viewBox="0 0 19 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
