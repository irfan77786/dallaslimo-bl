            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-11 col-xl-10">
                    <header class="mb-md-15 text-center">
                        ...
                        <p class="font-md">Have a question, need a quote, or planning upcoming travel? Our team is ready
                            to assist with bookings, custom requests, and real-time support—every step of the way.</p>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-11 col-xl-10">
                <form action="{{ route('contact_us_post') }}" method="post"
                    class="contact-us-form bg-white px-20 px-sm-30 py-30">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-12 mb-15">
                            <p class="font-sm mb-2">Do you agree to receive texts from Dallas Black Cars Limo Service
                                (+1 214-919-5377)? Messages may include reservation reminders/updates. Msg &amp; data
                                rates may apply. Reply STOP to unsubscribe or HELP for support.</p>
                            <div class="form-check pl-0 d-flex mt-2">
                                <input
                                    class="form-check-input ml-0 flex-shrink-0 @error('sms_consent') is-invalid @enderror"
                                    type="checkbox" id="sms_consent" name="sms_consent" value="1"
                                    style="margin-left: 0;" required>
                                <label class="form-check-label small d-inline-block ms-2" for="sms_consent"
                                    style="margin-top: -2px;">Yes, I agree to receive text messages from Dallas Black
                                    Cars Service sent from (+1 214-919-5377).</label>
                            </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4 card-with-icon-list-item mb-20">
                    <article class="card-with-icon">
                        ...
                        <p>Need immediate assistance or a last-minute ride? Call or text us anytime to speak
                            ...
                            <b>Phone</b>: <a href="tel:+12148978056">+1 214-919-5377</a>
                        </p>
                ...
                <div class="col-12 col-sm-6 col-lg-4 card-with-icon-list-item mb-20">
                    <article class="card-with-icon">
                        ...
                        <p>For corporate accounts, event transportation, group travel, or detailed requests,
                            ...
                            <b>Email</b>: <a
                                href="mailto:info@dallaslimosandblackcarservice.com">info@dallaslimosandblackcarservice.com</a>
                        </p>
                    </article>
                </div>
                <div class="col-12 col-sm-6 col-lg-4 card-with-icon-list-item mb-20">
                    ...
                    <article class="card-with-icon">
                        <span class="icon-holder d-flex align-items-center justify-content-center mb-15">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" viewBox="0 0 16 16">
                                <path fill="#fff"
                                    d="M8 .52a5.39 5.39 0 0 0-5.59 5.15c0 5 3.88 8.61 5.17 9.66a.66.66 0 0 0 .84 0c1.29-1.05 5.17-4.63 5.17-9.66A5.39 5.39 0 0 0 8 .52zM8 14a15.2 15.2 0 0 1-2.46-2.76a9.85 9.85 0 0 1-1.88-5.57A4.14 4.14 0 0 1 8 1.77a4.14 4.14 0 0 1 4.34 3.9c0 4.08-2.96 7.16-4.34 8.33z" />
                                <path fill="#fff"
                                    d="M8 2.54a2.73 2.73 0 0 0-2.84 2.65A2.74 2.74 0 0 0 8 7.84a2.75 2.75 0 0 0 2.83-2.65A2.74 2.74 0 0 0 8 2.54zm0 4.05a1.49 1.49 0 0 1-1.57-1.4A1.49 1.49 0 0 1 8 3.79a1.5 1.5 0 0 1 1.58 1.4A1.5 1.5 0 0 1 8 6.59z" />
                            </svg>
                        </span>
                ...
                <div class="col-12 col-sm-6 col-lg-4 card-with-icon-list-item mb-20">
                    <article class="card-with-icon">
                        ...
                        <p>
                            ...
                            • <span class="theme-color">Reserve Online</span> <br> • <span class="theme-color">Request a
                                Quote</span> <br> • <span class="theme-color">View Our
                                Fleet</span>
                        </p>
                    </article>
                </div>
