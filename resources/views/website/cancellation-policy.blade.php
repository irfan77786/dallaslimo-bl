                ...
                <ol class="list-unstyled custom-order-list">
                    ...
                    <li class="h5">
                        <div>
                            ...
                            <p>When possible, we will make reasonable efforts to reschedule services or issue refunds
                                minus non-refundable costs.</p>
                        </div>
                    </li>
                    <li class="h5">
                        <div>
                            <h3 class="h5 fw-medium">Indemnification</h3>
                            <p>By booking our services, you agree to indemnify and hold harmless Dallas Limos and Black
                                Car Service from any claims, losses, or damages arising from:</p>
                            <ul class="list-unstyled custom-unorder-list">
                                <li class="mb-0">
                    ...
                    <li class="h5">
                        <div>
                            ...
                            <ul class="list-unstyled custom-unorder-list">
                                ...
                                <li class="mb-0">
                                    <p class="mb-0">Clients must confirm pickup details and remain reachable to avoid
                                        no-show charges</p>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="h5">
                        <div>
                            ...
                            <ul class="list-unstyled custom-unorder-list">
                                <li class="mb-0">
                                    <p class="mb-0">Events such as weddings, concerts, and sporting events require a
                                        14-day cancellation notice</p>
                                </li>
                                <li class="mb-0">
                    ...
                    <li class="h5">
                        <div>
                            ...
                            <ul class="list-unstyled custom-unorder-list">
                                ...
                                <li class="mb-0">
                                    <p class="mb-0">No refunds are issued for Motor Coaches, Mini Buses, or Special
                                        Event services once the cancellation window has passed</p>
                                </li>
                            </ul>
                        </div>
                    </li>
                </ol>
                <p>Dallas Limos and Black Car Service is dedicated to providing professional, reliable transportation
                    supported by fair and clearly defined policies. We appreciate your trust in our services.</p>
