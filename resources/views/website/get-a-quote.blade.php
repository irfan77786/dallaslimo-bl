            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-11 col-xl-10">
                    <header class="mb-md-15 text-center">
                        ...
                        <p class="font-md">Request a customized quote for Black Car Service Dallas. Enter your trip
                            details below and receive accurate pricing without delay.</p>
                        <div class="text-center">
                            <a href="#quote-form" class="btn btn-primary text-capitalize">Request Quote</a>
                            <a href="tel:+12148978056" class="btn btn-outline-light ms-2 text-capitalize">Call: +1
                                214-919-5377</a>
                        </div>
                    </header>
                </div>
...
<div class="p-15" id="quote-form">
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-11 col-xl-10">
                    <header class="mb-35 mb-sm-40 text-center mb-md-50">
                        ...
                        <p>Request a customized quote for Black Car Service Dallas. Enter your trip details below and
                            receive accurate pricing without delay.</p>
                    </header>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-12 col-lg-11 col-xl-10">
                    ...
                    <form action="{{ route('get_a_quote_post') }}" method="post"
                        class="get-a-quote-form bg-white px-20 px-sm-30 py-30">
                        @csrf
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-4 mb-15">
                                <label for="vehicle_type" class="form-label mb-1 fw-medium">Select Vehicles
                                    Option:</label>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-15">
                                <label for="number_of_passengers" class="form-label mb-1 fw-medium">No. of
                                    Passengers</label>
                                <input type="text"
                                    class="form-control @error('number_of_passengers') is-invalid @enderror"
                                    id="number_of_passengers" name="number_of_passengers" placeholder="Number of Pax"
                                    required>
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-15">
                                ...
                                <input type="date" class="form-control @error('trip_date') is-invalid @enderror"
                                    id="trip_date" name="trip_date" required>
                                @error('trip_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-12 col-md-6 col-lg-4 mb-15">
                                ...
                                <input type="time" class="form-control @error('trip_time') is-invalid @enderror"
                                    id="trip_time" name="trip_time" required>
                                @error('trip_time')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-12 col-md-6 col-lg-4 mb-15">
                                <label for="pickup-location_quote" class="form-label mb-1 fw-medium">Pickup
                                    Address</label>
                                <div class="position-relative">
                                    <input type="text"
                                        class="form-control @error('pickup_address') is-invalid @enderror"
                                        id="pickup-location_quote" name="pickup_address"
                                        placeholder="Street, City, State" value="{{ old('pickup_address') }}" required
                                        autocomplete="off">
                            ...
                            <div class="col-12 col-md-6 col-lg-4 mb-15">
                                <label for="dropoff-location_quote" class="form-label mb-1 fw-medium">Drop Off
                                    Address</label>
                                <div class="position-relative">
                                    <input type="text"
                                        class="form-control @error('dropoff_address') is-invalid @enderror"
                                        id="dropoff-location_quote" name="dropoff_address"
                                        placeholder="Street, City, State" value="{{ old('dropoff_address') }}" required
                                        autocomplete="off">
                            ...
                            <div class="col-12 mb-15">
                                ...
                                <textarea class="form-control @error('message') is-invalid @enderror" id="message"
                                    name="message"
                                    placeholder="Add any special requests or additional information..."></textarea>
                                @error('message')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
            ...
            <div class="row align-items-center py-20">
                ...
                <div class="col-12 col-md-6 h-100">
                    <div class="img-holder ms-md-auto">
                        <img src="{{ asset('dallaslimo-bl-design/assets/areas-we-serve.webp') }}" class="img-fluid"
                            alt="Areas we serve">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="img-holder">
                        <img src="{{ asset('dallaslimo-bl-design/assets/fleet-img.webp') }}" alt="Fleet Image"
                            class="img-fluid">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-sm-6 col-md-4 mb-25 mb-md-30 d-flex ">
                    <article class="custom-card d-flex flex-column w-100 bg-white">
                        <span class="icon-holder mb-20">
                            <img src="{{ asset('new_assets/assets/icon-02.svg') }}" alt="Confirmation"
                                class="img-fluid">
                        </span>
    ...
    Swal.fire({
        ...
        html: {!! json_encode($errors->all()) !!}.join('<br>'),
        icon: 'error',
