                ...
                <div class="row justify-content-center">
                    <div id="home-text-content" class="col-12 col-lg-11 col-xl-10">
                        <header class="mb-md-15 text-center">
                            <h1 class="h1 fw-semibold text-center">Our Fleet</h1>
                            <p class="font-md">Serving Dallas, Frisco, Plano, Allen, and DFW Airport with executive sedans, SUVs, and limousines for airport, corporate, and VIP travel.</p>
