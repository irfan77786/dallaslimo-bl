            ...
            <div class="row justify-content-center">
                <div id="home-text-content" class="col-12 col-lg-11 col-xl-10">
                    <header class="mb-md-15 text-center">
                        ...
                        <p class="font-md">Reserve your premium black car or limousine service in Dallas. Professional
                            chauffeurs available 24/7 for airport transfers, corporate travel, and special events.
                            <br class="d-none d-md-block"> Experience luxury transportation with competitive rates.
                        </p>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-lg-11 col-xl-10 text-md-center">
                ...
                <h2 class="h2 fw-bold mb-10 text-center">Why Choose Dallas Limos and Black Car Service</h2>
        ...
        <div class="row py-20">
            ...
            <div class="col-12 col-md-4 h-100">
                <div class="img-holder ms-md-auto">
                    <img loading="lazy" decoding="async"
                        src="{{ asset('dallaslimo-bl-design/assets/why-choose-dallas-black-limo-service.webp') }}"
        ...
        <div class="row flex-row-reverse py-20 d-none d-md-flex">
            ...
            <div class="col-12 col-md-4 h-100 d-none d-md-flex">
                <div class="img-holder">
                    <img loading="lazy" decoding="async"
                        src="{{ asset('dallaslimo-bl-design/assets/areas-we-serve.webp') }}" width="406" height="233"
                        class="img-fluid" alt="Black car service Dallas city transportation">
                </div>
            </div>
        </div>
    </div>
